   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" class="box" required maxlength="100" placeholder="masukkan kategori produk" name="category">
         </div>
         <div class="inputBox">
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="admin_category.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('hapus produk ini?');">Hapus</a>
      </div>
   </div>
   <?php
         }
