<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         <h3>contact us</h3>
         <a href="#"><i class="fas fa-phone"></i> +62 856 0918 3504</a>
         <a href="#"><i class="fas fa-phone"></i> +62 215 821 2421</a>
         <a href="#"><i class="fas fa-envelope"></i>fryzecom@gmail.com</a>
         <a href="#"><i class="fas fa-map-marker-alt"></i> Bandar Lampung, Indonesia</a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>fryzecom</span> | all rights reserved!</div>
